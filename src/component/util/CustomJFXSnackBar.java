 ...
 * worth.
 */
public class CustomJFXSnackBar extends Group {
    ...
    public CustomJFXSnackBar() {
        this(null, null);
    }

    public CustomJFXSnackBar(Stage stage, Pane snackbarContainer) {
        toast = new Label();
        ...
        toastContainer.setPadding(new Insets(60));
